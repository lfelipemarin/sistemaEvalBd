    ...
    public void getUsuario(Usuario u, String param, ConexionDb c) {
        ...
        try {
            ...
            if (u.getApellido() != null && !u.getApellido().equals("")) {
                if (sentencia.contains("codigo") || sentencia.contains("nombre")) {
            ...
            if (u.getRol() != 0) {
                if (sentencia.contains("codigo") || sentencia.contains("nombre") || sentencia.contains("apellido")) {
                    sentencia += "AND rol = ? ";
                } else {
                    sentencia += " rol = ? ";
                }
